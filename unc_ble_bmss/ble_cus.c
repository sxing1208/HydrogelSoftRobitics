...
static uint32_t custom_value_char_add(ble_cus_t * p_cus, const ble_cus_init_t * p_cus_init)
{
    ...
    attr_char_value.init_len  = 48;
    attr_char_value.init_offs = 0;
    attr_char_value.max_len   = 48;
...
uint32_t ble_cus_custom_value_update(ble_cus_t * p_cus, char * custom_value)
{
    ...
    if (p_cus->conn_handle != BLE_CONN_HANDLE_INVALID) 
    {
        ...
        {
          err_code = sd_ble_gatts_sys_attr_set(p_cus->conn_handle, NULL, 0, 0);
          APP_ERROR_CHECK(err_code);
          NRF_LOG_INFO("Reset GATTS Sys Attr");
        }
